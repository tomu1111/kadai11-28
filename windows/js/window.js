...
function cman_winOpen(){
    var wH = cman_calH("DISP", "1");  // 最大高さの計算
    var wW = cman_calW("DISP", "3");  // 横幅1/4の計算
    var wT = cman_calT("DISP", "LT", wH);  // モニター中央 Top計算
    var wL = cman_calL("DISP", "LT", wW);  // モニター中央 Left計算
    var wOption = "top=" + wT + ", left=" + wL + ", height=" + wH + ", width=" + wW;

    // 画面を開く
    var winObj = window.open("https://www.amazon.co.jp/Prime-Video/b?ie=UTF8&node=3535604051", "null", wOption);
    winObj.focus();
